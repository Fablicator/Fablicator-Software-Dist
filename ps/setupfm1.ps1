...
git clone --branch "kisslicer-fm1" $dist_repo "$dist_root/KISSlicer"

# Setup KISSlicer defaults
& "$dist_root/KISSlicer/Scripts/ps/loaddefaults.ps1"

# Setup SX Marlin Calibration
Copy-Item -Path "$dist_root/Marlin/CalibrationDefaults/FM1/Calibration.h" -Destination "$dist_root/Marlin/Marlin/Calibration.h"